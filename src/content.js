...
const WORD_BANK = {
  ...
  little: [
    ...
    { cat: 'pet',     label: 'Choose a buddy',     options: [{w:'puppy',    e:'🐶'}, {w:'bunny',     e:'🐰'}, {w:'kitten',  e:'🐱'}, {w:'turtle',  e:'🐢'}, {w:'parrot',    e:'🦜'}, {w:'piglet',  e:'🐷'}, {w:'lamb',     e:'🐑'}, {w:'hamster',   e:'🐹'}, {w:'duckling', e:'🐥'}, {w:'hedgehog', e:'🦔'}, {w:'cub',      e:'🐻'}, {w:'foal',     e:'🐴'}, {w:'guinea pig',e:'🐹'}, {w:'pony',     e:'🐴'}, {w:'seal',     e:'🦭'}, {w:'squirrel', e:'🐿️'}, {w:'baby goat',e:'🐐'}, {w:'chick',    e:'🐥'}] },
  ...
  kid: [
    ...
    { cat: 'place',   label: 'Pick a location',        options: [{w:'jungle',    e:'🌴'}, {w:'castle',    e:'🏰'}, {w:'cavern',    e:'🕳️'}, {w:'forest',    e:'🌲'}, {w:'meadow',    e:'🌾'}, {w:'canyon',    e:'🏞️'}, {w:'volcano',   e:'🌋'}, {w:'labyrinth', e:'🌀'}, {w:'shipwreck', e:'⚓'}, {w:'glacier',   e:'🧊'}, {w:'rooftop',   e:'🏙️'}, {w:'desert',    e:'🏜️'}, {w:'treehouse', e:'🌳'}, {w:'lighthouse',e:'🗼'}, {w:'carnival',  e:'🎡'}, {w:'aquarium',  e:'🐠'}, {w:'planetarium',e:'🪐'},{w:'bakery',    e:'🥐'}, {w:'school cafeteria',e:'🏫'}, {w:'grocery store',e:'🛒'}, {w:'diner',     e:'🍔'}, {w:'mall',      e:'🛍️'}, {w:'bus stop',  e:'🚌'}, {w:'playground',e:'🛝'}] },
    ...
    { cat: 'mood',    label: 'Pick a feeling',         options: [{w:'silly',     e:'🤪'}, {w:'sneaky',    e:'🕵️'}, {w:'brave',     e:'🦁'}, {w:'goofy',     e:'🎪'}, {w:'spooky',    e:'👻'}, {w:'grumpy',    e:'😤'}, {w:'wobbly',    e:'🫨'}, {w:'dramatic',  e:'🎭'}, {w:'mysterious',e:'🌙'}, {w:'determined',e:'💪'}, {w:'clumsy',    e:'🤦'}, {w:'legendary', e:'🏆'}, {w:'cozy',      e:'🥰'}, {w:'suspiciously polite',e:'🎩'},{w:'professionally confused',e:'🤔'},{w:'ridiculously cheerful',e:'🌟'},{w:'sleepy',    e:'😴'}, {w:'jubilant',  e:'🎉'}, {w:'snacky',    e:'🍿'}, {w:'confused',  e:'🤔'}, {w:'overexcited',e:'🤩'}, {w:'suspicious',e:'🕵️'}, {w:'extra brave',e:'🦁'}, {w:'secretly proud',e:'😌'}] },
  ],
  big: [
