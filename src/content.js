...
const WORD_BANK = {
  ...
  kid: [
    ...
    { cat: 'food',    label: 'Pick a snack',           options: [{w:'tacos',     e:'🌮'}, {w:'donuts',    e:'🍩'}, {w:'quesadilla',e:'🫓'}, {w:'sushi',     e:'🍣'}, {w:'waffles',   e:'🧇'}, {w:'pizza',     e:'🍕'}, {w:'ramen',     e:'🍜'}, {w:'burritos',  e:'🌯'}, {w:'dumplings', e:'🥟'}, {w:'ice cream', e:'🍦'}, {w:'pretzels',  e:'🥨'}, {w:'grilled cheese',e:'🥪'}, {w:'spaghetti', e:'🍝'}, {w:'popcorn',   e:'🍿'}, {w:'hot dogs',  e:'🌭'}, {w:'pancakes',  e:'🥞'}, {w:'cupcakes',  e:'🧁'}, {w:'french fries',e:'🍟'}, {w:'milkshake', e:'🥤'}, {w:'cereal',    e:'🥣'}, {w:'garlic bread',e:'🥖'}, {w:'pickles',   e:'🥒'}, {w:'cheese puffs',e:'🧀'}, {w:'birthday cake',e:'🎂'}, {w:'fried chicken',e:'🍗'}, {w:'smoothie',  e:'🧋'}, {w:'warm croissant',e:'🥐'}] },
    ...
    { cat: 'mood',    label: 'Pick a feeling',         options: [{w:'silly',     e:'🤪'}, {w:'sneaky',    e:'🕵️'}, {w:'brave',     e:'🦁'}, {w:'goofy',     e:'🎪'}, {w:'spooky',    e:'👻'}, {w:'grumpy',    e:'😤'}, {w:'wobbly',    e:'🫨'}, {w:'dramatic',  e:'🎭'}, {w:'mysterious',e:'🌙'}, {w:'determined',e:'💪'}, {w:'clumsy',    e:'🤦'}, {w:'legendary', e:'🏆'}, {w:'cozy',      e:'🥰'}, {w:'polite',e:'🎩'},{w:'puzzled',e:'🧩'},{w:'ridiculously cheerful',e:'🌟'},{w:'sleepy',    e:'😴'}, {w:'super happy',e:'😄'}, {w:'snacky',    e:'🍿'}, {w:'confused',  e:'😵‍💫'}, {w:'overexcited',e:'🤩'}, {w:'suspicious',e:'🤨'}, {w:'extra brave',e:'🛡️'}, {w:'secretly proud',e:'😌'}, {w:'curious',   e:'🔍'}, {w:'worried',   e:'😟'}] },
  ],
  big: [
