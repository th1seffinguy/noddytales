...
const WORD_BANK = {
  tot: [
    ...
    { cat: 'place', label: 'Pick a place',            options: [{w:'park',    e:'🌳'}, {w:'pond',   e:'🦆'}, {w:'farm',   e:'🐄'}, {w:'beach',  e:'🏖️'}, {w:'yard',   e:'🌻'}, {w:'hill',   e:'⛰️'}, {w:'woods',  e:'🌲'}, {w:'house',  e:'🏠'}, {w:'shop',   e:'🏪'}, {w:'bridge', e:'🌉'}, {w:'field',  e:'🌾'}, {w:'sandbox',e:'🏖️'}] },
    ...
    { cat: 'move',  label: 'Pick a wiggle',           options: [{w:'hop',     e:'🐇'}, {w:'spin',   e:'🌀'}, {w:'run',    e:'💨'}, {w:'skip',   e:'🌈'}, {w:'jump',   e:'🦘'}, {w:'clap',   e:'👏'}, {w:'crawl',  e:'🐛'}, {w:'splash', e:'💦'}, {w:'roll',   e:'⚽'}, {w:'sway',   e:'🌊'}, {w:'stomp',  e:'🦶'}, {w:'wiggle', e:'🐍'}] },
  ],
  little: [
    ...
    { cat: 'food',    label: 'Choose a treat',     options: [{w:'pizza',    e:'🍕'}, {w:'cookies',   e:'🍪'}, {w:'muffins', e:'🧁'}, {w:'grapes',  e:'🍇'}, {w:'noodles',   e:'🍜'}, {w:'popcorn', e:'🍿'}, {w:'sandwich', e:'🥪'}, {w:'waffles',   e:'🧇'}, {w:'strawberries',e:'🍓'},{w:'dumplings',e:'🥟'}, {w:'soup',     e:'🍲'}, {w:'marshmallows',e:'🍡'}] },
    ...
    { cat: 'creature',label: 'Choose a creature',  options: [{w:'frog',     e:'🐸'}, {w:'fish',      e:'🐠'}, {w:'beetle',  e:'🐞'}, {w:'turtle',  e:'🐢'}, {w:'rabbit',    e:'🐰'}, {w:'snail',   e:'🐌'}, {w:'owl',      e:'🦉'}, {w:'fox',       e:'🦊'}, {w:'deer',     e:'🦌'}, {w:'penguin',  e:'🐧'}, {w:'crab',     e:'🦀'}, {w:'firefly',  e:'🌟'}] },
    { cat: 'move',    label: 'Choose a move',      options: [{w:'jump',     e:'🦘'}, {w:'dance',     e:'💃'}, {w:'wiggle',  e:'🐛'}, {w:'gallop',  e:'🏇'}, {w:'twirl',     e:'🌀'}, {w:'bounce',  e:'⚡'}, {w:'splash',   e:'💦'}, {w:'tiptoe',    e:'👣'}, {w:'zoom',     e:'💨'}, {w:'hop',      e:'🐇'}, {w:'skid',     e:'🛷'}, {w:'flop',     e:'🌊'}] },
  ...
  kid: [
    ...
    { cat: 'food',    label: 'Pick a snack',           options: [{w:'tacos',     e:'🌮'}, {w:'donuts',    e:'🍩'}, {w:'nachos',    e:'🧀'}, {w:'sushi',     e:'🍣'}, {w:'waffles',   e:'🧇'}, {w:'pizza',     e:'🍕'}, {w:'ramen',     e:'🍜'}, {w:'churros',   e:'🥐'}, {w:'dumplings', e:'🥟'}, {w:'ice cream', e:'🍦'}, {w:'pretzels',  e:'🥨'}, {w:'grilled cheese',e:'🧀'}] },
    ...
    { cat: 'move',    label: 'Pick a move',            options: [{w:'zooming',   e:'⚡'}, {w:'tiptoeing', e:'👣'}, {w:'bouncing',  e:'🏀'}, {w:'spinning',  e:'🌀'}, {w:'leaping',   e:'🦘'}, {w:'galloping', e:'🏇'}, {w:'tumbling',  e:'🤸'}, {w:'gliding',   e:'🪂'}, {w:'charging',  e:'🐂'}, {w:'creeping',  e:'🐛'}, {w:'soaring',   e:'🦅'}, {w:'skating',   e:'⛸️'}] },
  ...
  big: [
    ...
    { cat: 'color',   label: 'Pick a wild color',     options: [{w:'shimmering gold',         e:'✨'}, {w:'electric violet',        e:'⚡'}, {w:'deep crimson',          e:'🔴'}, {w:'luminous teal',         e:'🌊'}, {w:'faded amber',           e:'🍂'}, {w:'impossible green',      e:'🌿'}, {w:'impossible orange',     e:'🍊'}, {w:'eerie periwinkle',      e:'🟣'}, {w:'violently pleasant blue',e:'🔵'},{w:'suspiciously beige',    e:'🟤'}, {w:'strangely familiar grey',e:'🩶'},{w:'obviously red',         e:'🔴'}] },
    { cat: 'food',    label: 'Pick a peculiar snack', options: [{w:'enchanted pickles',       e:'🥒'}, {w:'thunder pancakes',       e:'🥞'}, {w:'suspicious sandwiches', e:'🥪'}, {w:'bewildering biscuits',  e:'🍪'}, {w:'haunted crumpets',      e:'🫖'}, {w:'legendary soup',        e:'🍲'}, {w:'suspicious casserole',  e:'🍱'}, {w:'haunted macaroni',      e:'🍝'}, {w:'ancient granola bar',   e:'🥣'}, {w:'overconfident pudding', e:'🍮'}, {w:'mysterious leftovers',  e:'🥡'}, {w:'famously wrong recipe', e:'📖'}] },
    ...
    { cat: 'move',    label: 'Pick a verb',           options: [{w:'cartwheeled',             e:'🤸'}, {w:'tiptoed cautiously',     e:'👣'}, {w:'stumbled dramatically', e:'💫'}, {w:'waltzed accidentally',  e:'💃'}, {w:'skipped solemnly',      e:'🎵'}, {w:'meandered thoughtfully',e:'🌀'}, {w:'tripped magnificently', e:'💃'}, {w:'stood dramatically still',e:'⏸️'},{w:'reversed unexpectedly', e:'↩️'}, {w:'paused for effect',     e:'🎭'}, {w:'scuttled with purpose', e:'🦀'}, {w:'fell upward somehow',   e:'⬆️'}] },
  ...
  tween: [
    ...
    { cat: 'color',   label: 'Pick your aesthetic',   options: [{w:'neon green',   e:'💚'}, {w:'void black',     e:'🖤'}, {w:'burnt orange', e:'🧡'}, {w:'dusty rose',   e:'🌸'}, {w:'electric yellow',e:'⚡'}, {w:'midnight blue',e:'🌌'}, {w:'moss green',   e:'🌿'}, {w:'acid yellow',  e:'💛'}, {w:'deep purple',  e:'💜'}, {w:'washed out grey',e:'🩶'},{w:'rust orange',  e:'🍂'}, {w:'iridescent',   e:'🌈'}] },
    ...
    { cat: 'place',   label: 'Pick a location',       options: [{w:'abandoned mall',e:'🏚️'}, {w:'rooftop',      e:'🏙️'}, {w:'skatepark',    e:'🛹'}, {w:'arcade',       e:'🕹️'}, {w:'bus stop',     e:'🚌'}, {w:'parking garage',e:'🚗'}, {w:'library at closing time',e:'📚'},{w:'empty school hallway',e:'🏫'},{w:'convenience store',e:'🏪'},{w:'slightly wrong neighbourhood',e:'🗺️'},{w:'the back of the bus',e:'🚌'},{w:'someone else\'s backyard',e:'🌿'}] },
    { cat: 'creature',label: 'Pick a creature',       options: [{w:'cryptid',      e:'👁️'}, {w:'gremlin',      e:'👺'}, {w:'discount vampire',e:'🧛'}, {w:'feral librarian',e:'📚'}, {w:'shadow entity',e:'🌑'}, {w:'sentient vending machine',e:'🤖'},{w:'stressed barista',e:'☕'},{w:'mysterious substitute teacher',e:'🎓'},{w:'aggressively normal pigeon',e:'🐦'},{w:'wifi ghost',e:'📶'},{w:'the algorithm',e:'📱'},{w:'a very confident rat',e:'🐀'}] },
    { cat: 'move',    label: 'Pick an action',        options: [{w:'dramatically sighed',e:'😮‍💨'}, {w:'speed-ran', e:'💨'}, {w:'casually yeeted',e:'🏌️'}, {w:'existentially paused',e:'🫠'}, {w:'chaotically bolted',e:'💥'}, {w:'mysteriously vanished',e:'🌫️'},{w:'immediately regretted',e:'🫣'},{w:'aggressively scrolled',e:'📱'},{w:'passive-aggressively waved',e:'👋'},{w:'said nothing and left',e:'🚪'},{w:'took a very long sip',e:'☕'},{w:'nodded knowingly',e:'😌'}] },
    { cat: 'mood',    label: 'Pick a vibe',           options: [{w:'chronically online',e:'📱'}, {w:'suspiciously unbothered',e:'😌'}, {w:'barely functional',e:'☕'}, {w:'terminally curious',e:'🔍'}, {w:'aggressively normal',e:'🙂'}, {w:'weirdly proud',e:'😤'}, {w:'main character energy',e:'✨'},{w:'NPC behaviour',e:'🤖'}, {w:'menacingly chill',e:'😶'}, {w:'lowkey feral',e:'🐺'}, {w:'professionally unhinged',e:'💼'},{w:'catastrophically fine',e:'🙂'}] },
  ],
};
...
const FREE_TEXT_ROUNDS = {
  ...
  big: [
    ...
    { type: 'freetext', cat: 'freeword',  label: "What would a haunted biscuit say?",                       examples: ['crumble', 'I was delicious', 'chew me not'] },
  ...
  tween: [
    ...
    { type: 'freetext', cat: 'freeword2', label: "Name a cryptid you would absolutely trust.",              examples: ['Mothman', 'a very organised Bigfoot', 'the good kind of shadow person'] },
