...
const WORD_BANK = {
  ...
  big: [
    ...
    { cat: 'food',    label: 'Pick a peculiar snack', options: [{w:'enchanted pickles',       e:'🥒'}, {w:'thunder pancakes',       e:'🥞'}, {w:'suspicious sandwiches', e:'🥪'}, {w:'bewildering cookies',   e:'🍪'}, {w:'haunted scones',        e:'🫖'}, {w:'legendary soup',        e:'🍲'}, {w:'suspicious casserole',  e:'🍱'}, {w:'haunted macaroni',      e:'🍝'}, {w:'ancient granola bar',   e:'🥣'}, {w:'overconfident pudding', e:'🍮'}, {w:'mysterious leftovers',  e:'🥡'}, {w:'famously wrong recipe', e:'📖'}] },
